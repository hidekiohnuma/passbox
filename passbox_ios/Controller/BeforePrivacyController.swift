...
class BeforePrivacyController: UIViewController, UIWebViewDelegate  {
    ...
    func loadAddressURL(){
        ...
        //Webビューの生成
        _webView = makeWebView(CGRectMake(0, 150,
        ...
        //HTMLの読み込み(3)
        let url: NSURL = NSURL(string: "http://153.126.185.130:8080/app/privacy")!
