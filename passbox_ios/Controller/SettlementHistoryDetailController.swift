...
class SettlementHistoryDetailController: UIViewController, UITableViewDelegate ,UITableViewDataSource, UITabBarDelegate{
    ...
    override func viewDidLoad() {
        ...
        var nib = UINib(nibName: "SettlementHistoryDetailView", bundle: nil)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCellWithIdentifier("Cell") as? SettlementHistoryDetailView
