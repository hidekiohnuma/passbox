...
class BaggageOrderListController: UIViewController, UITableViewDelegate ,UITableViewDataSource, UITabBarDelegate{
    
    @IBOutlet weak var tableView: UITableView!
    
    var orderId: [Int] = []
    var BaggageOrderLists:[BaggageOrderList] = [BaggageOrderList]()
    ...
    override func viewDidLoad() {
        ...
        var nib = UINib(nibName: "BaggageOrderListView", bundle: nil)
        ...
        manager.GET("http://153.126.185.130:8080/api/v1/orders",parameters: nil,
            success: { (operation: AFHTTPRequestOperation!, responseObject:AnyObject!) in
                ...
                for i in 0..<count{
                    ...
                    var i = BaggageOrderList(label1: projectTitle as? String, label2:start as? String,label2_2:destination as? String,label3:loadDate as? String,label4:baggageType as? String,label5:orderUserName as? String,label6:budgetUpper as? String,imageName:(img as? String)!)
                    self.BaggageOrderLists.append(i)
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section:Int) -> Int {
        return BaggageOrderLists.count
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCellWithIdentifier("Cell") as? BaggageOrderListView
        
        //cell中身セット（引数　セル、indexPath）
        cell?.setCell(BaggageOrderLists[indexPath.row])
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let mySecondViewController = storyboard.instantiateViewControllerWithIdentifier("BaggageOrderStatusController") as! UIViewController
